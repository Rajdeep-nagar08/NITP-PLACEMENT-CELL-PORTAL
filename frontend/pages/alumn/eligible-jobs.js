...
import NoResume from '@/components/alumni/NoResume'
...
export default function EligibleJobs({ token = '' }) {
  ...
  useEffect(() => {
    fetch(`${API_URL}/api/alumn/eligiblejobs`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    })
  ...
  //     const res = await fetch(`${API_URL}/api/alumni/apply?jobId=${id}`, {
  //       method: 'POST',
  //       headers: {
  ...
  //       router.push(`/alumni/jobs-applied`)
  //     }
  //   }
  // }
