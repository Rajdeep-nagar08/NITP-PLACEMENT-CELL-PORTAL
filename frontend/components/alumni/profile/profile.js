...
export default function Profile({ alumn, token }) {
  const [alumnData, setStudentData] = useState(alumn)
  ...
  const handleSubmitCpi = async (e) => {
    ...
    if (
      confirm(
        ...
        Details:
        CPI: ${alumnData.cpi}
        Sem 1 SPI: ${alumnData.spi_1}
        Sem 2 SPI: ${alumnData.spi_2}
        Sem 3 SPI: ${alumnData.spi_3}
        Sem 4 SPI: ${alumnData.spi_4}
        Sem 5 SPI: ${alumnData.spi_5}
        Sem 6 SPI: ${alumnData.spi_6}
        Sem 7 SPI: ${alumnData.spi_7}
        Sem 8 SPI: ${alumnData.spi_8}
        `
      )
    ) {
      // formdata
      const formData = new FormData()
      formData.append('cpi', alumnData.cpi)
      formData.append('spi_1', alumnData.spi_1)
      formData.append('spi_2', alumnData.spi_2)
      formData.append('spi_3', alumnData.spi_3)
      formData.append('spi_4', alumnData.spi_4)
      formData.append('spi_5', alumnData.spi_5)
      formData.append('spi_6', alumnData.spi_6)
      formData.append('spi_7', alumnData.spi_7)
      formData.append('spi_8', alumnData.spi_8)

      const res = await fetch(`${API_URL}/api/alumn/modify`, {
        method: 'PUT',
        headers: {
  ...
  const handleChange = (e) => {
    e.preventDefault()
    setStudentData({ ...alumnData, [e.target.name]: e.target.value })
  }
      ...
      <div className='border-t border-gray-200 px-4 py-5 sm:p-0'>
        <dl className='sm:divide-y sm:divide-gray-200'>
            ...
            <div className='py-4 sm:py-5 sm:grid sm:grid-cols-4 sm:gap-4 sm:px-6'>
              ...
              <dd className='mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-1'>
                {alumn.profile_pic ? (
                  <div>
                    <Image
                      src={API_URL + alumn.profile_pic.url}
                      width={140}
                      height={180}
                      objectFit='cover'
                      alt='alumn profile'
          ...
          <div className='py-4 sm:py-5 sm:grid sm:grid-cols-4 sm:gap-4 sm:px-6'>
            ...
            <dd className='mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-1'>
              {alumn.personal_email_id}
            </dd>
            <dt className='text-sm font-medium text-gray-500'>
              Institute Email
            </dt>
            <dd className='mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-1'>
              {alumn.institute_email_id}
            </dd>
          </div>
          ...
          <div className='py-4 sm:py-5 sm:grid sm:grid-cols-4 sm:gap-4 sm:px-6'>
            ...
            <dd className='mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-1'>
              {alumn.mobile_number_1}
            </dd>
            <dt className='text-sm font-medium text-gray-500 sm:col-span-1'>
              Mobile Number 2
            </dt>
            <dd className='mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-1'>
              {alumn.mobile_number_2}
            </dd>
          </div>
          <div className='py-4 sm:py-5 sm:grid sm:grid-cols-4 sm:gap-4 sm:px-6'>
            <dt className='text-sm font-medium text-gray-500 sm:col-span-1'>
                ...
                <li className='pl-3 pr-4 py-3 flex items-center justify-between text-sm'>
                  <div className='w-0 flex-1 flex items-center'>
                    ...
                    <span className='ml-2 flex-1 w-0 truncate'>
                      {alumn.resume ? alumn.resume.name : 'No resume found'}
                    </span>
                  </div>
