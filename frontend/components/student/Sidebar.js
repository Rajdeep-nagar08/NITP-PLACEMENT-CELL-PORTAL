  ...
  return (
    <div>
        ...
        >
          ...
          >
            <div className='relative flex-1 flex flex-col max-w-xs w-full bg-gray-800'>
              ...
              <div className=' h-0 pt-5 pb-4 overflow-y-auto '>
                      ...
                      <a
                        className={classNames(
                          item.href === router.pathname
                            ...
                            : 'text-gray-200 hover:bg-stone-900 hover:text-white',
                          'group flex items-center px-2  text-base font-medium '
                        )}
                      >
                        <item.icon
                          className={classNames(
                  ...
                  <a
                    ...
                    className={classNames(
                      false
                        ? 'bg-gray-900 text-white'
                        : 'text-gray-200 hover:bg-stone-900 hover:text-white',
                      'group flex items-center px-2  text-base font-medium cursor-pointer'
                    )}
                  >
                    <LogoutIcon
                      className={classNames(
      ...
      <div className='hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0 md:right-0 '>
        ...
        <div className='flex-1 flex flex-col min-h-0 bg-stone-800 pt-5 font-mono'>
          <div className='flex-1 flex flex-col pt-5 pb-4 overflow-y-auto'>
            ...
            <nav className='flex-1 pt-5'>
              {navigation.map((item) => (
                <Link key={item.name} href={item.href}>
                  <a
                    className={classNames(
                      item.href === router.pathname
                        ? 'bg-gray-200 text-black pr-3 right-2 relative rounded-md'
              ...
              <a
                ...
                className={classNames(
                  false
                    ? 'bg-gray-200 text-black pr-3 right-3 relative rounded-md'
                    : 'text-gray-300 hover:bg-gray-700 hover:text-white',
          ...
          <div className='flex-shrink-0 flex bg-stone-900 p-4'>
      ...
      <div className='md:pr-64 flex flex-col flex-1'>
        ...
        <main className='flex-1'>
          <div className='py-6 bg-gray-200'>
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 lg:grid lg:justify-items-center'>
